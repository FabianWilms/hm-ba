...
OAuth2 bietet zur Autorisierung sogenannte \textit{Grant Types} an. Vier an der Zahl, und alle für unterschiedliche Anwendungsfälle. Ziel dieser Grant Types ist es, den \textit{access token} eines Nutzers zu erhalten, der Informationen über seine Rechte enthält.
