...
Das Deployment ist in Microservice-Architekturen ein wichtiger Punkt, da eine gute Deployment-Infrastruktur auch für den Nutzen einer solchen Architektur entscheidend sein kann: keine downtime, kurze Zeit bis Lösungen den Kunden erreichen und einfache Skalierbarkeit. Es gibt verschiedene Ansätze, wie man eine Anwendung zum Einsatz bringen kann\cite{richardsondeploy}.
