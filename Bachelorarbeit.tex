...
Im Rahmen dieser Arbeit wird die mögliche Steigerung der Qualität von Microservice Anwendungen ohne die Erhöhung von Zeit und Kosten durch die Generierung von Tests geprüft. Dazu werden zunächst spezifische Vorgehensweisen zum testen von Microservice-Architekturen erläutert. Diese werden dann im nächsten Schritt, mit dem Ansatz zur generativen Testerstellung im Hinterkopf, implementiert um sie anschließend in die bestehende Infrastruktur zur Generierung von Microservice-Architekturen bei der Stadt zu integrieren und somit die Softwarequalität steigern zu können. Der generative Ansatz ermöglicht teilweise die angestrebte Qualitätssteigerung, wenn auch einige Einschränkungen in der Bandbreite der generierten Tests zu erkennen ist.

\vspace{-1,2em}
\titlespacing{\section}{0pt}{12pt plus 4pt minus 2pt}{-6pt plus 2pt minus 2pt}
\section*{Abstract}

This thesis deals with the possible enhancement of the quality of microservice applications without increasing the time and costs of the porject by generating tests. To validate this claim specific methods are explained which are especially useful for testing microservice architectures. These methods then get implemented while taking into concern that these tests shall be generated at a later point. The generation of these tests partly fulfills the desired rise in quality even though there are recognizable limitations to the spectrum in which the generated tests can operate.
