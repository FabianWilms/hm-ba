...
ist die zweite Art der asynchronen Kommunikation. Der größte Unterschied zum Ansatz der Messages liegt darin, dass bei der Verwendung von Events kein expliziter Empfänger genannt wird, sondern alle Services ein Event empfangen, und eigenständig entscheiden, ob sie dieses Event verarbeiten wollen, oder nicht(siehe Fig.~\ref{fig:images/img_event-driven.eps}).
...
\begin{description}
	...
	%--------------
	\item[Erhöhte Widerstandsfähigkeit gegenüber Fehlern im System], da die Grenzen von Microservices eine Kaskadierung von Fehlern verhindern können.
...
\paragraph{Consumer Driven Contract Testing}
